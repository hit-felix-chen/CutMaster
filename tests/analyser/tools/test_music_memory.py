...
from cutmaster.analyser.tools.music_analysis import (
    _duration_range,
    _normalize,
    _section_boundaries,
...
def test_analyze_music_memory_uses_the_complete_source_track(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.load",
        lambda *_args, **_kwargs: (samples, 4),
    )
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.get_duration",
        lambda **_kwargs: 8.0,
    )
    ...
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.feature.rms",
        fake_rms,
    )
    ...
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.onset.onset_strength",
        fake_onset,
    )
    ...
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.feature.spectral_centroid",
        fake_centroid,
    )
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.beat.beat_track",
        lambda **_kwargs: (np.array([120.0]), np.array([1, 3])),
    )
    monkeypatch.setattr(
        "cutmaster.analyser.tools.music_analysis.librosa.frames_to_time",
