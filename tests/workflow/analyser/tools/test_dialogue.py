...
from cutmaster.workflow.analyser.tools.dialogue import candidate_passages, parse_srt, postprocess_dialogues
...
def test_dialogue_batches_run_in_parallel_and_preserve_cue_order(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("cutmaster.workflow.analyser.tools.dialogue._chunk_passages", two_chunks)
